# STILL NEED TO DO THIS FOR FASTER MAP GENERATION
...
Na = len(arr_a_deg)
Nie = len(arr_ie)
arr_inputs = mesh.reshape(Na*NPIX*Nie*N_inj,3) # flatten to 2D array
...
jdlfile.write("Output = /het/p4/"+username+"/gcewavelets/skysearch/condor/"+runname+'$(npix)'+'_'+'$(ie)'+'_'+'$(a)'+'$(injid)'+'_'+".out\n")
